          ...
          <div className="text-center space-y-3">
            {status.available && status.deviceConnected ? (
              ...
              <div className="space-y-3">
                ...
                <Button
                  className="w-full h-14 text-base bg-primary text-primary-foreground shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 animate-pulse"
