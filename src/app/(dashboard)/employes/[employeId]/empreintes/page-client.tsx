      ...
      <CardContent className="space-y-4">
        ...
        {phase === "idle" && (!status.available || !status.deviceConnected) && (
          <div className="space-y-3">
            ...
            <Button
              className="w-full h-12 text-base bg-blue-600 text-white shadow-lg shadow-blue-600/30 hover:bg-blue-800 hover:shadow-xl hover:shadow-blue-800/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 animate-pulse-dark"
